...
// hash:sha256:793a8287dc34ca5632069a298d2c0f2f2f023d3cf6c7c7df6eee5c93788b1919

nextflow.enable.dsl = 1

capsule_create_parameters_json_21_to_capsule_filtering_11_1 = channel.create()
...
capsule_create_parameters_json_21_to_capsule_calculate_incongruous_genes_cell_pairs_cell_13_5 = channel.create()
capsule_filtering_11_to_capsule_calculate_incongruous_genes_cell_pairs_cell_13_6 = channel.create()
capsule_create_parameters_json_21_to_capsule_mapping_hierarchial_flat_combined_14_7 = channel.create()
capsule_calculate_incongruous_genes_cell_pairs_cell_13_to_capsule_mapping_hierarchial_flat_combined_14_8 = channel.create()
...
process capsule_filtering_11 {
	tag 'capsule-0717009'
	container "$REGISTRY_HOST/published/b252f053-0776-4db0-882f-45121c541aaf:v4"
	...
	input:
	path 'capsule/data/params/' from capsule_create_parameters_json_21_to_capsule_filtering_11_1.collect()
	path 'capsule/data/' from capsule_add_cluster_labelsto_cells_by_section_12_to_capsule_filtering_11_2

	output:
	path 'capsule/results/*' into capsule_filtering_11_to_capsule_calculate_incongruous_genes_cell_pairs_cell_13_6
	...
	git clone --branch v4.0 "https://\$GIT_ACCESS_TOKEN@\$GIT_HOST/capsule-0717009.git" capsule-repo
...
process capsule_calculate_incongruous_genes_cell_pairs_cell_13 {
	tag 'capsule-6238842'
	container "$REGISTRY_HOST/published/b2697690-5109-422f-bf7b-d15b8cb9ca6b:v2"

	cpus 4
	memory '16 GB'

	input:
	path 'capsule/data/params/' from capsule_create_parameters_json_21_to_capsule_calculate_incongruous_genes_cell_pairs_cell_13_5.collect()
	path 'capsule/data/sections/' from capsule_filtering_11_to_capsule_calculate_incongruous_genes_cell_pairs_cell_13_6

	output:
	path 'capsule/results/*' into capsule_calculate_incongruous_genes_cell_pairs_cell_13_to_capsule_mapping_hierarchial_flat_combined_14_8
	...
	echo "[${task.tag}] cloning git repo..."
	git clone --branch v2.0 "https://\$GIT_ACCESS_TOKEN@\$GIT_HOST/capsule-6238842.git" capsule-repo
	mv capsule-repo/code capsule/code
	rm -rf capsule-repo
...
process capsule_mapping_hierarchial_flat_combined_14 {
	tag 'capsule-1928280'
	container "$REGISTRY_HOST/capsule/d8f663b8-d522-4ed8-9467-44e8cf0610e2:5038d50b80bc3f7fd0df769ffbc2d959"

	cpus 8
	memory '96 GB'

	input:
	path 'capsule/data/params/' from capsule_create_parameters_json_21_to_capsule_mapping_hierarchial_flat_combined_14_7.collect()
	path 'capsule/data/sections/' from capsule_calculate_incongruous_genes_cell_pairs_cell_13_to_capsule_mapping_hierarchial_flat_combined_14_8
	...
	git -C capsule-repo checkout 28bf20074d4729f1b0fe2471c3020d9f1043ce08 --quiet
	mv capsule-repo/code capsule/code
	rm -rf capsule-repo
...
process capsule_add_cell_type_colors_combined_16 {
	...
	git -C capsule-repo checkout 662bb1d41ec09eb5b60493531af5e375a79dd86f --quiet
	mv capsule-repo/code capsule/code
	rm -rf capsule-repo
...
process capsule_combine_sections_17 {
	tag 'capsule-6755013'
	container "$REGISTRY_HOST/published/63183105-cbc9-4372-bbd8-a138ac1b9b16:v2"
	...
	echo "[${task.tag}] cloning git repo..."
	git clone --branch v2.0 "https://\$GIT_ACCESS_TOKEN@\$GIT_HOST/capsule-6755013.git" capsule-repo
	mv capsule-repo/code capsule/code
	rm -rf capsule-repo
...
process capsule_save_processing_results_18 {
	...
	input:
	path 'capsule/data/whole_dataset/' from capsule_double_mad_filtering_hierarchical_flat_combined_20_to_capsule_save_processing_results_18_14.collect()
	...
	git -C capsule-repo checkout 25f796e6208a617675e36cdcc3c2c4457aa5b2df --quiet
	mv capsule-repo/code capsule/code
	rm -rf capsule-repo
...
process capsule_double_mad_filtering_hierarchical_flat_combined_20 {
	...
	output:
	path 'capsule/results/whole_dataset/hrc_CDM*.h5ad' into capsule_double_mad_filtering_hierarchical_flat_combined_20_to_capsule_save_processing_results_18_14
	...
	git -C capsule-repo checkout 09e650a846d35e399f03c664046b769c2fc815cb --quiet
	mv capsule-repo/code capsule/code
	rm -rf capsule-repo
...
process capsule_create_parameters_json_21 {
	...
	output:
	path 'capsule/results/*' into capsule_create_parameters_json_21_to_capsule_filtering_11_1
	path 'capsule/results/*' into capsule_create_parameters_json_21_to_capsule_add_cluster_labelsto_cells_by_section_12_3
	path 'capsule/results/*' into capsule_create_parameters_json_21_to_capsule_calculate_incongruous_genes_cell_pairs_cell_13_5
	path 'capsule/results/*' into capsule_create_parameters_json_21_to_capsule_mapping_hierarchial_flat_combined_14_7
	...
	git -C capsule-repo checkout 92e0ec93d1e5d4cd0e0b2c533aa170a32049fd8c --quiet
	mv capsule-repo/code capsule/code
	rm -rf capsule-repo
